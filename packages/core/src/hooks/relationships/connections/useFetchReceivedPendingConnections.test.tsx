...
import useFetchReceivedPendingConnections from "./useFetchReceivedPendingConnections";
...
describe("useFetchReceivedPendingConnections", () => {
  it("fetches connection requests the current user received", async () => {
    ...
    const page = makePage([
      { id: "connection-1", user: makeUser(), createdAt: "2024-01-01T00:00:00.000Z", type: "received" },
    ]);
    ...
    expect(call.url).toBe("/test-project/connections/pending/received");
