...
[![npm](https://img.shields.io/npm/v/@sublay/ui-core-react-native.svg)](https://www.npmjs.com/package/@sublay/ui-core-react-native)
...
React Native UI primitives for Sublay-powered apps — avatars, infinite-scroll triggers, modals, relative-time formatters, GIF pickers, skeletons. Designed to be composed with the Sublay React Native SDK ([`@sublay/react-native`](https://www.npmjs.com/package/@sublay/react-native) or [`@sublay/expo`](https://www.npmjs.com/package/@sublay/expo)) and the higher-level components distributed through the Sublay CLI registry.

```bash
npm install @sublay/ui-core-react-native
```
