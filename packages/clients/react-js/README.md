# Replyke Core - React JS

> **Note:** This package is designed for React applications. It provides seamless integration with React projects, including optimized hooks and components. It includes `@replyke/core` under the hood, so you do not need to install it separately.
