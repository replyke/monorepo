...
[![npm](https://img.shields.io/npm/v/@sublay/ui-core-react-js.svg)](https://www.npmjs.com/package/@sublay/ui-core-react-js)
...
React (web) UI primitives for Sublay-powered apps — avatars, infinite-scroll triggers, modals, relative-time formatters, GIF pickers, skeletons. Designed to be composed with the Sublay React SDK ([`@sublay/react-js`](https://www.npmjs.com/package/@sublay/react-js)) and the higher-level components distributed through the Sublay CLI registry.

```bash
npm install @sublay/ui-core-react-js
```
...
3. Optionally drop in the open-source [`@sublay/ui-core-*`](https://github.com/sublay-io/monorepo/tree/main/packages/ui-core-react-js) primitives, or install full components via the Sublay CLI registry.
