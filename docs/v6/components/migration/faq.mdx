...
<AccordionGroup>
  <Accordion title="Where can I get help?" icon="life-ring">
    ...
    - **GitHub Issues:** [github.com/sublay-io/monorepo/issues](https://github.com/sublay-io/monorepo/issues)
  </Accordion>
  ...
  <Accordion title="Can I contribute?" icon="heart">
    **Yes!** The components are open source. Contributions welcome:
    ...
    Visit the [GitHub repo](https://github.com/sublay-io/monorepo/tree/main/packages/cli) to contribute.
  </Accordion>
</AccordionGroup>
