...
<ResponseField name="isEntitySaved" type="(entityId: string, collectionId?: string) => Promise<{ saved: boolean; inSpecificCollection?: boolean; collections: Array<{ id: string; name: string }> }>">
