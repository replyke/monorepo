...
The argument is required, and `mode` determines what else is required — enforced by TypeScript as a discriminated union, not just documented.

<ParamField body="mode" type='"code" | "link"' required>
